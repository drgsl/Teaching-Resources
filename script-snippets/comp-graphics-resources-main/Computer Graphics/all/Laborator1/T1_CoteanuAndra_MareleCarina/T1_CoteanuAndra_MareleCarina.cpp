// T1_CoteanuAndra_MareleCarina.cpp : This file contains the 'main' function. Program execution begins and ends there.
//
...
void Display3() {
    ...
    glBegin(GL_POINTS);
    // de completat ...
    glVertex2f(0.5, 0.5);   //sus dreapta
    glVertex2f(-0.5, 0.5);  //sus stanga
    glVertex2f(0.5, -0.5);  //jos dreapta
    glVertex2f(-0.5, -0.5); //jos stanga
    glEnd();
}
...
void Display4() {
    ...
    // de completat ...
    glVertex2f(1, 1);       //punct de start sus
    glVertex2f(1, 0.8);     //punct jos => linie
    glVertex2f(0.5, 0.5);   // urmatorul punct => linie oblica
    glVertex2f(0.5, 0.3);
    glEnd();
}
...
void Display5() {
    ...
    glVertex2f(0.5, 0.5);   
    glVertex2f(0.5, 0.3);
    // la fel ca la display4, dar aici e line_loop => 
    // => enumeram cateva puncte, functia asta creaza linii intre ele si apoi uneste primul cu ultimul punct rezultand un loop
    glEnd();
}
...
void Display6() {
    ...
    // de completat ...
    glVertex2f(1, 1);       // cel mai din dreapta si sus punct
    glVertex2f(1, 0.85);    // cel mai din dreapta si jos punct
    glVertex2f(0.85, 0.85); // cel mai din stanga si jos punct
    // celalalt triunghi e la fel dar in oglinda, adica toate valorile cu -
    glVertex2f(-1, -1);
    glVertex2f(-1, -0.85);
