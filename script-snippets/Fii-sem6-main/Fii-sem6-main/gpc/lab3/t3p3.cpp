...
// the size of the window measured in pix~els
#define dim 300
...
public:
  void segmentKoch(double lungime, int nivel, CPunct &p, CVector v)
  {
    ...
    {
      segmentKoch(lungime / 2.0, nivel - 1, p, v);
...
class CCarpetaSierpinski{
public:
  void patratSierpinski(double lungime, int nivel, CPunct &p)
  {
    ...
    CVector v3(-1, 0);
    CPunct p3(x + lungime / 2, y - lungime / 2);

    CVector v4(0,1);
    CPunct p4(x - lungime / 2, y - lungime / 2);
    ...
    {
      patratSierpinski(lungime, nivel - 1, p);
      ...
      patratSierpinski(lungime/3, nivel - 1, p1);

      CPunct p2(x, y + lungime);
      patratSierpinski(lungime/3, nivel - 1, p2);

      CPunct p3(x + lungime, y);
      patratSierpinski(lungime/3, nivel - 1, p3);

      CPunct p4(x, y - lungime);
      patratSierpinski(lungime/3, nivel - 1, p4);

      CPunct p5(x - lungime, y + lungime);
      patratSierpinski(lungime/3, nivel - 1, p5);

      CPunct p6(x + lungime, y + lungime);
      patratSierpinski(lungime/3, nivel - 1, p6);

      CPunct p7(x + lungime, y - lungime);
      patratSierpinski(lungime/3, nivel - 1, p7);

      CPunct p8(x - lungime, y - lungime);
      patratSierpinski(lungime/3, nivel - 1, p8);
  ...
  void afisare(double lungime, int nivel)
  {
    // CVector v(0.0, 0.0);
    CPunct p(0.0, 0.0);
    patratSierpinski(lungime, nivel, p);
  }
};

class CArborePerronMirrored
{
public:
  void arborePerron(double lungime, 
                    int nivel, 
...
// displays the Sierpiński carpet
void Display5(){
  CCarpetaSierpinski ccs;
  ccs.afisare(0.5, nivel);
...
// displays the Pedos tree
void Display6(){
  CArborePerronMirrored capMirrored;
